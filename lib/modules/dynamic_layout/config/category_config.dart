...
class CategoryConfig {
  ...
  bool enableFilterCategory = false;
  ...
  CategoryConfig({
    ...
    this.enableFilterCategory = false,
  ...
  CategoryConfig.fromJson(dynamic json) {
    ...
    enableFilterCategory =
        bool.tryParse(json['enableFilterCategory'].toString()) ?? false;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['enableFilterCategory'] = enableFilterCategory;
