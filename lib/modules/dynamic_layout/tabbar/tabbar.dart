...
class _TabBarState extends State<TabBar> {
  ...
  Decoration get _indicator {
    ...
    final TabBarThemeData tabBarThemeData = TabBarTheme.of(context);
    if (tabBarThemeData.indicator != null) {
      return tabBarThemeData.indicator!;
    }
    ...
    if (widget.automaticIndicatorColorAdjustment &&
        color.isEqualTo(Material.of(context).color)) {
      color = Colors.white;
    }
      ...
      if (widget.tabs[index] is PreferredSizeWidget) {
        ...
        if (widget.tabHasTextAndIcon &&
          ...
          if (widget.labelPadding != null ||
              tabBarThemeData.labelPadding != null) {
            adjustedPadding = (widget.labelPadding ??
                    tabBarThemeData.labelPadding!)
    ...
    for (int index = 0; index < tabCount; index += 1) {
      ...
      final MouseCursor effectiveMouseCursor =
          WidgetStateProperty.resolveAs<MouseCursor?>(
              ...
              tabBarThemeData.mouseCursor?.resolve(states) ??
      ...
      wrappedTabs[index] = InkWell(
        ...
        overlayColor: widget.overlayColor ?? tabBarThemeData.overlayColor,
        splashFactory: widget.splashFactory ?? tabBarThemeData.splashFactory,
