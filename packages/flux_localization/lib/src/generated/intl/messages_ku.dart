...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m17(day) => "${day} ڕۆژ پێش ئێستا";

  static String m19(timeLeft) => "${timeLeft} تەواو دەبێت";

  static String m21(message) => "هەڵە: ${message}";

  static String m23(time) => "بەسەردەچێت لە ${time}";

  static String m25(hour) => "${hour} کاتژمێر پێش ئێستا";
  ...
  static String m32(minute) => "${minute} خولەك پێش ئێستا";

  static String m36(itemCount) => "${itemCount} ئایتم";

  static String m37(price) => "کۆى گشتى هەڵبژاردنەکان: ${price}";

  static String m43(percent) => "داشکاندن ${percent} %";

  static String m47(second) => "${second} چرکە پێش ئێستا";
  ...
  static String m51(total) => "${total} بەرهەمەکان";

  static String m55(date) => "گونجاوە تا ${date}";

  static String m58(message) => "ئاگاداری: ${message}";

  static String m60(length) => "${length} بەرهەم دۆزرایەوە";

  static String m66(point) => "تۆ هەندێك پۆینتت هەیە";
