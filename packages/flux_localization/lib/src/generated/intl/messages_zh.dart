...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(state) => "蓝牙适配器状态：${state}";

  static String m5(author) => "作者：${author}";

  static String m6(fieldName) => "${fieldName}不能为空。";

  static String m7(fieldName) => "${fieldName}不能少于3个字符。";

  static String m8(currency) => "已将货币更改为${currency}";

  static String m9(number) => "还可输入${number}个字符";

  static String m10(priceRate, pointRate) => "${priceRate} = ${pointRate}积分";

  static String m11(count) => "${count}项";

  static String m12(count) => "${count}个项目";
  ...
  static String m20(captcha) => "输入${captcha}进行确认：";
  ...
  static String m24(total) => "大于${total}公里";

  static String m25(hour) => "${hour} 小时前";

  static String m26(currentBalance) => "您的钱包余额仅剩${currentBalance}";

  static String m27(message) => "应用程序在请求数据时出现问题，请联系管理员解决：${message}";
  ...
  static String m35(number) => "必须按${number}件为单位购买";
  ...
  static String m39(name) => "已将${name}添加到购物车";

  static String m40(total) => "数量：${total}";

  static String m41(name) => "已收到来自${name}的款项";

  static String m42(count) => "是否要从心愿单中移除${count}件商品？";

  static String m43(percent) => "优惠 ${percent}%";

  static String m44(keyword) => "\"${keyword}\"的搜索结果";

  static String m45(keyword, count) => "${keyword}（${count}项）";

  static String m46(keyword, count) => "${keyword}（${count}项）";
  ...
  static String m51(total) => "${total} 个商品";
  ...
  static String m59(defaultCurrency) => "当前选择的货币不支持钱包功能，请改为${defaultCurrency}";

  static String m60(length) => "找到 ${length} 个商品";
  ...
  static String m64(count) => "您已选择${count}个商品";

  static String m65(total) => "您已被分配订单#${total}";
